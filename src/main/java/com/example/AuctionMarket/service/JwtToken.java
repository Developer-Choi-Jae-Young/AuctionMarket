...
public class JwtToken {
    ...
    public JwtToken(String secret, long accessTokenValidityInSeconds, long refreshTokenValidityInSeconds) {
        this.secret = secret;
    ...
    // 토큰 생성
    public String accessTokenCreateToken(Authentication authentication) {
    ...
    // 토큰 생성
    public String refreshTokenCreateToken(Authentication authentication) {
        String authorities = authentication.getAuthorities().stream()
                .map(GrantedAuthority::getAuthority)
                .collect(Collectors.joining(","));
        log.info(authorities);
    ...
    {
        String returnValue = request.getHeader(JwtProperties.HEADER_REFRESH_STRING);
        return returnValue;
    }
}